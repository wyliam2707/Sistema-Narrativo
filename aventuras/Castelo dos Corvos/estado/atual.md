...
## Ponto operacional
- Corvin recebeu Ravena no Castelo dos Corvos e a levou à grande biblioteca principal.
- Ravena procura informações sobre Trigon, especialmente linhagem, vínculos dimensionais, descendência como âncora e formas de compreender ou limitar esse vínculo.
- Corvin permitiu que ela consulte e faça anotações, com a condição de que nenhum livro saia do castelo.
- Ravena aceitou a condição e está pesquisando na biblioteca.
- Corvin explicou que os textos devem ser lidos criticamente, pois obras de cultistas podem conduzir o leitor a conclusões que favoreçam o senhor demoníaco.
...
- Ravena aceitou a possibilidade de permanecer no castelo durante o estudo.
- Corvin → Ravena: surgiu atração física e interesse pessoal durante a conversa na biblioteca; Corvin pretende manter isso discreto por enquanto.
- Ravena → Corvin: nenhum sentimento romântico estabelecido de forma conhecida por Corvin.
