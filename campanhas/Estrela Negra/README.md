...
A primeira temporada foi arquivada como unidade histórica em:

`livro/temporada-1/`

A pasta contém:

- capítulos `001.md` a `020.md`;
- `epilogo.md`;
- `resumo-da-temporada.md` para reancoragem e criação de temporadas futuras;
- `mapa-de-eventos.md` para consulta cronológica e causal.
