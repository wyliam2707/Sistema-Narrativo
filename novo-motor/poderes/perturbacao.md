...
Poder modular baseado na família nociva **Perturbação**.
...
**Dano:** Nenhum → 1d6 → 2d6  
**Efeito:** Perturbação: Desorientado → Confuso → Atordoado  
...
- **Perturbação:** Desorientado `+0` → Confuso `+1` → Atordoado `+2`
...
## Progressão de Perturbação

- **Desorientado:** `-1d` em resoluções mentais.
- **Confuso:** `-2d` em resoluções mentais; o jogador continua decidindo suas ações.
- **Atordoado:** não pode realizar ações enquanto o estado durar.
