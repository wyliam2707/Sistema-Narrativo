...
Quando relevante, a sentença deve deixar claro:

- quem agiu;
- o que efetivamente fez;
- onde estava;
- contra quem ou contra o quê agiu;
- o que foi percebido;
- quanto tempo realmente passou;
- qual consequência ocorreu;
- como a situação ficou depois.
...
- opções disponíveis;
- posição ou distância relevante;
- cobertura;
- saída ou entrada;
- recurso;
- arma;
...
O Narrador pode conhecer mais do que a perspectiva apresentada.

Isso não autoriza revelar tudo.
...
A cena apresenta apenas aquilo que a perspectiva atual pode legitimamente:
...
Ações automáticas, naturais, rotineiras ou já determinadas pelos fatos podem aparecer dentro da sentença.
