# Comparação e Disputa

Status: APROVADO

Esta regra define como o NARRADOR resolve situações em que mais de um resultado continua plausível depois de ler a cena e as capacidades envolvidas.

> **A cena define a pergunta. A ficha informa quem consegue responder a essa pergunta e em que nível.**

---

## 1. Comparar somente o que responde à mesma pergunta
...
## 3. A cena vem antes da ficha

Nenhum valor da ficha possui um resultado automático fora de contexto.

O NARRADOR primeiro identifica:

```text
O que está acontecendo?
↓
O que cada agente está tentando conseguir?
↓
O que realmente pode impedir isso?
↓
Quais capacidades respondem a essas questões?
↓
Qual resultado a combinação produz?
```
...
> **Patamares são qualitativos. A cena determina sua manifestação concreta.**

---

## 4. Potência, técnica, meio e situação

Uma ação pode depender de dimensões diferentes.

Como ferramenta de leitura, o NARRADOR pode distinguir:

- **Potência** — quanto aquela capacidade consegue produzir;
- **Técnica** — quão bem o personagem sabe executar aquilo;
- **Meio** — com que ferramenta, poder, material ou mecanismo ele está agindo;
- **Situação** — posição, distância, tempo, surpresa, informação, terreno, preparação, estado atual e demais condições relevantes.
...
## 5. Capacidade alta não substitui informação nem repertório
...
## 6. Estratégia muda o problema

Uma boa ideia não aumenta o patamar do personagem.
...
## 7. Preparação cria condições, não bônus
...
> **Estratégia escolhe quais capacidades terão oportunidade de importar.**

---

## 8. Uma solução boa pode encerrar um problema grande
...
Quando uma boa ideia elimina uma ameaça, a campanha continua a partir da nova realidade.
...
Não se acrescenta retroativamente uma trava de fuga apenas porque o adversário encontrou uma saída que o plano original não cobria.

---

## 10. Disputa equilibrada pode permanecer aberta

Nem toda disputa precisa terminar imediatamente em sucesso ou falha.
...
## 11. Nova decisão abre nova janela
...
## 12. Continuidade como critério secundário

O NARRADOR deve ser justo com os fatos, capacidades, ações e consequências da cena.

Continuidade não é uma força que corrige resultados claros.

Ela só pode orientar a escolha quando, depois de considerar tudo que realmente importa, mais de um resultado continua praticamente equivalente e a situação exige uma decisão naquele momento.

Mesmo nesses casos, sempre que a própria disputa puder continuar coerentemente, o NARRADOR pode preservá-la aberta em vez de forçar um vencedor.

> **Continuidade desempata incerteza real; não protege planos, protagonistas, antagonistas ou problemas já resolvidos.**

---

## 13. Exemplo de campanha — pacto com Trigon
...
> **Problema resolvido é problema resolvido. A campanha segue da consequência.**
...
LEIA A CENA
↓
IDENTIFIQUE A PERGUNTA REAL
↓
COMPARE SOMENTE CAPACIDADES QUE RESPONDEM À MESMA PERGUNTA
↓
INTERPRETE AS DEMAIS COMO DIMENSÕES DIFERENTES DA AÇÃO
↓
APLIQUE MEIOS, INFORMAÇÃO, PREPARAÇÃO E SITUAÇÃO COMO FATOS
↓
RECONHEÇA DOMÍNIO QUANDO ELE EXISTIR
↓
RECONHEÇA SOLUÇÃO BOA QUANDO ELA REALMENTE RESOLVER O PROBLEMA
↓
SE NINGUÉM ALTERAR O ESTADO DA DISPUTA, ELA PODE CONTINUAR
↓
PARE QUANDO SURGIR NOVA DECISÃO
```

> **Não vença o número. Mude a situação.**
>
> **Não force um vencedor quando a disputa continua equilibrada.**
>
> **Não salve o planejamento de uma solução que funcionou.**
