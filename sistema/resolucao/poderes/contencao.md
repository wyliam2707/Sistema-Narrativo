...
Poder modular baseado na família nociva **Contenção**.
...
**Dano:** Nenhum → 1d6 → 2d6  
**Efeito:** Contenção: Lento → Imóvel → Paralisado  
...
- **Contenção:** Lento `+0` → Imóvel `+1` → Paralisado `+2`
...
O NARRADOR apresenta o Hub configurado, mostra o custo total e pede confirmação antes da resolução:
...
O Dano, se escolhido, é imediato. Depois, resolve-se o Efeito:
...
- **Efeito [Nula]:** não há etapa de Resistência.

## Progressão de Contenção

- **Lento:** reduz o deslocamento em um grau de alcance.
- **Imóvel:** impede deslocamento, mas ainda permite outras ações possíveis sem sair do lugar.
- **Paralisado:** impede ações físicas e deslocamento; ações puramente mentais ainda podem ser possíveis.
