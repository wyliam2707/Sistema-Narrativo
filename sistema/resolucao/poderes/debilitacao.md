...
Poder modular baseado na família nociva **Debilitação**.
...
**Dano:** Nenhum → 1d6 → 2d6  
**Efeito:** Debilitação: Fraco → Debilitado → Prostrado  
...
- **Debilitação:** Fraco `+0` → Debilitado `+1` → Prostrado `+2`
...
## Progressão de Debilitação

- **Fraco:** `-1d` em ações que dependam diretamente de força ou potência física.
- **Debilitado:** `-2d` nessas ações.
- **Prostrado:** ações que dependam de força ou potência física relevante podem se tornar inviáveis conforme a ficção.
