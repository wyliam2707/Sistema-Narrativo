...
Poder modular baseado na família nociva **Exaustão**.
...
**Dano:** Nenhum → 1d6 → 2d6  
**Efeito:** Exaustão: Fatigado → Exausto → Inconsciente  
...
- **Exaustão:** Fatigado `+0` → Exausto `+1` → Inconsciente `+2`
...
## Progressão de Exaustão

- **Fatigado:** `-1d` em ações físicas que exijam esforço relevante.
- **Exausto:** `-2d` em ações físicas que exijam esforço relevante.
- **Inconsciente:** perde a consciência e não pode realizar ações voluntárias enquanto o estado durar.
